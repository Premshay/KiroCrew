...
class _ChatSlot:
    ...
    def set_session_checkpoint(self, checkpoint: dict[str, Any]) -> bool:
        """Replace the current projection and append one bounded milestone."""
    ...
    def restore_session_checkpoint(self, checkpoint: object) -> None:
        """Restore a history checkpoint after reapplying the display bounds."""
    ...
    def session_checkpoint_payload(self) -> dict[str, Any] | None:
        """Return an isolated copy for the slots snapshot and Multiplex."""
