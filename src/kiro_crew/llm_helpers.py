...
async def background_turn(
    ...
    *,
    ...
    if memory_store:
        ...
        if session_key:
            # A private-store turn mints its own generated key and retires it
            # afterwards; a caller-supplied key would be deleted with it.
            raise ValueError("memory_store and session_key are mutually exclusive")
