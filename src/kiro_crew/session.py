...
class SessionManager:
    ...
    def _allocation_deps(self) -> AllocationDeps:
        constants = AllocationConstants(
            ...
            consolidate_key=CONSOLIDATE_KEY,
        ...
        return AllocationDeps(
            ...
            apply_runtime_client_binding=(
                lambda runtime_kwargs, binding: apply_runtime_client_binding(
                    runtime_kwargs, binding
                )
            ),
    ...
    @property
    def _idle_expiry_guard(self) -> "Callable[[str], bool] | None":
        return self._cleanup_state_boundary().idle_expiry_guard

    @_idle_expiry_guard.setter
    def _idle_expiry_guard(self, value: "Callable[[str], bool] | None") -> None:
        self._cleanup_state_boundary().idle_expiry_guard = value
    ...
    def set_idle_expiry_guard(self, guard: Callable[[str], bool] | None) -> None:
        ...
        self._cleanup_boundary().set_idle_expiry_guard(guard)
