...
class TestTombstoneResolvesRecoveryAction:
    ...
    @pytest.mark.parametrize(
        ("complete", "expected"), [(True, "result_available"), (False, "partial_result")]
    )
    def test_result_recovery_requires_recorded_completion(self, agent_root, complete, expected):
        ...
        update_state("withresult", result_complete=complete)
