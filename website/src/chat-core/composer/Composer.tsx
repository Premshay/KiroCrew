...
export type ComposerVoiceOptions = Pick<ComposerVoiceHost, 'isComposerFor' | 'deliverOffScreen' | 'onAutoSubmit' | 'pushToTalk' | 'handsFree'> & {
...
function VoiceAtomInner({ ctx }: { ctx: ComposerContextValue }) {
  ...
  const cv = useComposerVoice({
    ...
    handsFree: voiceOptions.handsFree,
  })
