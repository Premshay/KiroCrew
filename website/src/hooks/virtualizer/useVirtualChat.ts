...
export function useVirtualChat<T>(
  ...
  }, [getH, overscan, scrollerRef, leadingOffset, setWindowRange])
 ...
 const pinAuto = useCallback(() => {
  ...
  }, [overscan, scrollerEl, setWindowRange])
  ...
  const scrollToBottom = useCallback(
    ...
    [overscan, followOutput, scrollerRef, writeScrollTop, restoreOwnsPosition, setWindowRange],
  )
