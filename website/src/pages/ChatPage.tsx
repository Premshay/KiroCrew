                ...
                style={
                  {
                    ...
                    '--mc-content-width': CONTENT_WIDTH[chatConfig.contentWidth].messages,
                    '--mc-input-width': CONTENT_WIDTH[chatConfig.contentWidth].input,
                          ...
                          createPortal(
                            ...
                            <div
                              ...
                              style={(() => {
                                ...
                                return {
                                  bottom: window.innerHeight - agentBtnRect.top + 4,
                                  left,
                                }
                              })()}
                            >
