    ...
    <>
      ...
      <SettingsSection title={i18nT('pages.settings.chatPanel.messages')}>
        <SettingsCard>
          ...
          <SettingsSelect label={i18nT('pages.settings.chatPanel.response_verbosity')} description={i18nT('pages.settings.chatPanel.how_terse_the_agent_s_prose_is_ultra_concise_cap')} value={dashCfg.verbosity ?? 'default'} options={['default', 'concise', 'ultra']} optionLabels={[i18nT('pages.settings.chatPanel.default_normal_length'), i18nT('pages.settings.chatPanel.concise_trim_filler'), i18nT('pages.settings.chatPanel.ultra_concise_3_sentences')]} onChange={v => setDash({ verbosity: v as 'default' | 'concise' | 'ultra' })} disabled={dashDisabled} />
