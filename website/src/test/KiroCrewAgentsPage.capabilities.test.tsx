...
const mocks = vi.hoisted(() => ({
  api: {
    ...
    agentResolvedModel: vi.fn(), kirocrewAgentModels: vi.fn(), models: vi.fn(), crons: vi.fn(), webhooks: vi.fn(),
...
beforeEach(() => {
  ...
  mocks.api.kirocrewAgents.mockResolvedValue({ agents: [{ name: 'oncall', kiro_agent: 'atlas', workspace: 'default', memory_store: 'default', runtime_policy: { model: 'selectable' } }], default_agent: 'oncall' })
  ...
  mocks.api.kirocrewAgentModels.mockResolvedValue({ models: [{ modelId: 'test-model', name: 'Test model' }] })
